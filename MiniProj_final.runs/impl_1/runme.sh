...
HD_PWD='C:/Xilinx/Vivado/2019.2/bin/MiniProj_Final/MiniProj_final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Traffic_control_system.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Traffic_control_system.tcl -notrace
