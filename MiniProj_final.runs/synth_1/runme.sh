...
HD_PWD='C:/Xilinx/Vivado/2019.2/bin/MiniProj_Final/MiniProj_final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Traffic_control_system.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Traffic_control_system.tcl
